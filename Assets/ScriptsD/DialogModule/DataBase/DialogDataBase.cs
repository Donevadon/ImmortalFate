...
namespace Assets.DialogModule.DataBase
{
    ...
    {
        private ILocalize localize = new Localization();
        ...
        private string[][] GetDialogs(DialogManager.Scenes scene, DialogManager.Places place)
        {
            ...
            XDocument xml = XDocument.Load(Application.dataPath + $"/Resources/DB/Dropbox/Mortal Fate/Dialogs/{localize.language}/{scene}.xml");
